...
vim.api.nvim_set_keymap('n', '<C-b>', "<cmd>lua require('telescope.builtin').buffers({ ignore_current_buffer = true })<cr>", { silent = true, noremap = true })
...
vim.api.nvim_set_keymap('n', '<leader>aa', "<cmd>lua require('telescope.builtin').lsp_code_actions()<cr>", { silent = true, noremap = true })
